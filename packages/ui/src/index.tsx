...
const paths: Record<IconName, ReactNode> = {
  ...
  'cloud-off': (
    <>
      <path d="m3 3 18 18M7 17h10a4 4 0 0 0 1.8-7.6A6 6 0 0 0 8.2 7.2" />
      <path d="M5.2 9.7A4 4 0 0 0 7 17" />
    </>
  ),
  'file-text': (
    <>
  ...
  help: (
    <>
      ...
      <path d="M9.7 9a2.4 2.4 0 1 1 4.4 1.3c-.8 1-2.1 1.2-2.1 2.7M12 16h.01" />
    </>
  ),
  home: (
    <>
  ...
  layers: (
    <>
      <path d="m12 3 8 4-8 4-8-4zM4 12l8 4 8-4M4 17l8 4 8-4" />
    </>
  ),
  link: (
    <>
      <path d="M10 13a5 5 0 0 0 7.5.3l1.2-1.2a5 5 0 0 0-7.1-7.1l-.7.7" />
      <path d="M14 11a5 5 0 0 0-7.5-.3l-1.2 1.2a5 5 0 0 0 7.1 7.1l.7-.7" />
    </>
  ),
  lock: (
    <>
  ...
  shield: (
    <>
      <path d="M12 3 20 6v6c0 5-3.4 8.1-8 9-4.6-.9-8-4-8-9V6z" />
...
export function StateNotice({
  ...
  return (
    <div
      className={`ui-state-notice ui-state-notice-${tone}`}
